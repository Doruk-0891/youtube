...
export const FILTERS_LIST = ['React', 'Redux', 'Javascript', 'HTML', 'CSS', 'Bootstrap', 'TailwindCSS', 'MaterialUI', 'Git', 'DOM', 'Responsive Web', 'Github', 'LinkedIn', 'Frontend', 'React Hooks', 'Debouncing', 'Postman', 'Vercel', 'VSCode'];
